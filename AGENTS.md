...
- 中核仕様、実行基盤仕様、認証・認可仕様、API契約仕様、運用・データ保全仕様、実装統制仕様、Phase契約仕様、共通実装詳細仕様、内製化仕様、テスト仕様、Phase 1〜19 の詳細は `docs/spec/` に分割して管理する
