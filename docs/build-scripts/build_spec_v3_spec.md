...
| 入力 | UTF-8 エンコードの Markdown ファイル。`docs/spec/spec.md` から `docs/spec/auth.md`、`docs/spec/api.md`、`docs/spec/testing-policy.md`、`docs/spec/phase-*.md` を include 展開する |
...
<span class="hdr-ver">V.207</span>         # ← バージョンバッジ
```
