...
| 優先度 | 対象 | 現行クレート | 備考 |
|--------|------|------------|------|
| 1 | WAL チェックポイント制御 | libSQL | Phase 4 と直結 |
...
### 14.9 WebSocket セッション管理（Phase 3）
